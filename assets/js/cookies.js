...
(function () {
  ...
  function injectCSS() {
    ...
    var css = ''
      ...
      + '.hbt-cc__txt a{color:#C8A15A;text-decoration:underline;text-underline-offset:2px}'
      ...
      + '.hbt-btn:hover{border-color:#C8A15A;color:#C8A15A}'
      + '.hbt-btn--solid{background:#C8A15A;border-color:#C8A15A;color:#0A0A0A}'
      + '.hbt-btn--solid:hover{background:#fff;border-color:#fff;color:#0A0A0A}'
      ...
      + '.hbt-row h3{margin:0;font-size:.72rem;text-transform:uppercase;letter-spacing:.2em;color:#C8A15A;font-weight:500}'
      ...
      + '.hbt-sw input:checked+span{border-color:#C8A15A;background:rgba(200,161,90,.18)}'
      + '.hbt-sw input:checked+span::after{left:22px;background:#C8A15A}'
